...
CONTAINS
  ...
  SUBROUTINE calculate_irrigation_water_demand(i,j,area,sswcorrpar,immdeppar,  &
    ...
    ELSE  
      ...
      CALL calculate_kcb(cropiindex,current_time%dayno,kcb)  
  ...
  SUBROUTINE calculate_irrigation(i,na,irrigationpar,q,lakew,riverv,aquiferv, &
       ...
       nextirrigation,cnextirrigation,wblirrflows,wbrirrflows,wbrirrevap,aquiferloss,dampabstr)    
    ...
    REAL, INTENT(OUT)   :: dampabstr            !<main river damping box water abstraction for irrigation (m3/timestep)
