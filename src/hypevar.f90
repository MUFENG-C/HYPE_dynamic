...
!> \{
  ...
  INTEGER,PARAMETER :: o_crrl    = 420 !river water level in local reference system
  ...
  INTEGER,PARAMETER :: o_absr    = 532 !
  INTEGER,PARAMETER :: o_absl    = 533 !
  INTEGER,PARAMETER,DIMENSION(3) :: o_psoilDSI    = (/534,535,536/)   !class
  INTEGER,PARAMETER :: o_csoilDSi = 537   !class 
  INTEGER,PARAMETER :: o_crunDSi  = 538   !class 
  INTEGER,PARAMETER :: o_ccDSi    = 539  !subbasin
  INTEGER,PARAMETER :: o_ccASi    = 540  !subbasin
  INTEGER,PARAMETER :: o_ccSi     = 541  !subbasin
  INTEGER,PARAMETER :: o_clDSi    = 542  !subbasin
  INTEGER,PARAMETER :: o_clAsi    = 543  !subbasin
  INTEGER,PARAMETER :: o_clSi     = 544  !subbasin
  INTEGER,PARAMETER :: o_reSi     = 545  !outlet lake
  INTEGER,PARAMETER :: o_psub       = 546
  INTEGER,PARAMETER :: o_esub       = 547
  INTEGER,PARAMETER :: o_isub       = 548
  ! #CB Add HYPE variables
  INTEGER,PARAMETER :: o_olsp    = 549 !olake sediment production pool
  INTEGER,PARAMETER :: o_olsa    = 550 !age of sediment in olake production pool
  INTEGER,PARAMETER :: o_olsd    = 551 !density of settled sediments in olake
  INTEGER,PARAMETER :: o_olss    = 552 !depth of settled sediments in olake
  INTEGER,PARAMETER :: o_olld    = 553 !olake adjusted lake depth
  INTEGER,PARAMETER :: o_olsf    = 554 !olake sediment flush
  INTEGER,PARAMETER :: o_cmrq    = 555 !flow in main river
  INTEGER,PARAMETER :: o_c9IN    = 556 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9ON    = 557 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9SP    = 558 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9PP    = 559 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9OC    = 560 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9T1    = 561 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9T2    = 562 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9TN    = 563 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9TP    = 564 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9SS    = 565 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9AE    = 566 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9TS    = 567 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9DS    = 568 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9AS    = 569 !concentration of flow in main river
  INTEGER,PARAMETER :: o_c9Si    = 570 !concentration of flow in main river
  INTEGER,PARAMETER :: o_ssmx    = 571 !maximum sediment transport concentration for Bagnold equation
  INTEGER,PARAMETER :: o_sdrs    = 572 !amount of sedimentation/resuspension
  INTEGER,PARAMETER :: o_olas    = 573 ! #CB: sediment added to lake sediment pool (SS+AE) (kg)
  INTEGER,PARAMETER :: o_olan    = 574 !nitrogen settled in lake (kg)
  INTEGER,PARAMETER :: o_olap    = 575 !phosphorus settled in lake (kg)
  INTEGER,PARAMETER :: o_olac    = 576 !org.carbon settled in lake (kg)
  INTEGER,PARAMETER :: o_olai    = 577
  INTEGER,PARAMETER :: o_ola1    = 578 !T1 settled in lake
  INTEGER,PARAMETER :: o_olns    = 579
  !Maximum number of outvar
  INTEGER,PARAMETER :: o_max_outvar = 579     !number of output variables
...
!> \{
  ...
  INTEGER,PARAMETER :: n_gratk      = 13   !<Parameter variable index
  INTEGER,PARAMETER :: n_gratp      = 14   !<Parameter variable index
  ...
  INTEGER,PARAMETER :: n_iniSi      = 447
  INTEGER,PARAMETER :: n_w0adjdays  = 448
  INTEGER,PARAMETER :: n_lseddens   = 450
  INTEGER,PARAMETER :: n_erodmon    = 451 !Soil erosion monthly adjustment
  INTEGER,PARAMETER :: n_eroddecay  = 452
  INTEGER,PARAMETER :: n_qbank      = 453 ! #CB qbank factor
  INTEGER,PARAMETER :: n_addsusp    = 454 ! #CB Bagnold equation additional sediment factor
  INTEGER,PARAMETER :: n_vpeak      = 455 ! #CB Velocity peaking factor
  INTEGER,PARAMETER :: n_sedch      = 456 ! #CB Resuspension Channel Factor
  INTEGER,PARAMETER :: n_suspconSS  = 457 ! #CB Concentration Constant
  INTEGER,PARAMETER :: n_suspexpSS  = 458 ! #CB Concentration Exponent
  INTEGER,PARAMETER :: n_suspconPP  = 459 ! #CB Concentration Constant
  INTEGER,PARAMETER :: n_suspexpPP  = 460 ! #CB Concentration Exponent
  INTEGER,PARAMETER :: n_suspconT1  = 461 ! #CB Concentration Constant
  INTEGER,PARAMETER :: n_suspexpT1  = 462 ! #CB Concentration Exponent
  INTEGER,PARAMETER :: n_remdamdays = 463
  INTEGER,PARAMETER :: n_max_par    = 463 !<Maximum number of model parameters
!>\}
...
!> \{
  ...
  INTEGER,PARAMETER :: m_w0adjdays = 27 !<General model parameter index 
...
!--Surface runoff additional parameter
  ...
  INTEGER,PARAMETER :: m_weathdep = 273
  INTEGER,PARAMETER :: m_weathkt  = 274
  INTEGER,PARAMETER :: m_wprodsi   = 275
  INTEGER,PARAMETER :: m_sedsi     = 276
  INTEGER,PARAMETER :: m_sitmpexp  = 277
  INTEGER,PARAMETER :: m_plimsi    = 278  
  INTEGER,PARAMETER :: m_iniSi     = 279  !<General model parameter index
  INTEGER,PARAMETER :: m_lseddens  = 280
  INTEGER,PARAMETER :: m_eroddecay = 281 !Erosion pool decay
  INTEGER,PARAMETER :: m_qbank     = 282 ! qbank factor
  INTEGER,PARAMETER :: m_addsusp   = 283 ! Bagnold equation additional sediment factor
  INTEGER,PARAMETER :: m_vpeak     = 284 ! Velocity peaking factor
  INTEGER,PARAMETER :: m_sedch     = 285 ! Resuspension Channel Factor
  INTEGER,PARAMETER :: m_suspconSS = 286 ! Max suspension concentration Constant
  INTEGER,PARAMETER :: m_suspexpSS = 287 ! Max suspension concentration Exponent
  INTEGER,PARAMETER :: m_suspconPP = 288 ! Max suspension concentration Constant
  INTEGER,PARAMETER :: m_suspexpPP = 289 ! Max suspension concentration Exponent
  INTEGER,PARAMETER :: m_suspconT1 = 290 ! Max suspension concentration Constant
  INTEGER,PARAMETER :: m_suspexpT1 = 291 ! Max suspension concentration Exponent
  INTEGER,PARAMETER :: m_remdamdays = 292 !
!>\}
...
!> \{
  ...
  INTEGER,PARAMETER :: m_weathrate  = 39
...
!> \{
  ...
  INTEGER,PARAMETER :: m_ldwprodsi  = 19 !<LakeData parameter index
  INTEGER,PARAMETER :: m_ldsedsi    = 20 !<LakeData parameter index
  INTEGER,PARAMETER :: m_ldsedss    = 21 !<LakeData parameter index
  INTEGER,PARAMETER :: m_ldw0adjdays= 22 !<LakeData parameter index 
!>\}

!> \name Monthly dependent model parameter indices
!> \{
  INTEGER,PARAMETER :: m_mlapse   = 1
  INTEGER,PARAMETER :: m_erodmon  = 2 !Soil erosion monthly adjustment
!>\}
...
!> \{
    ...
    REAL,PARAMETER :: maxprodwater    = 0.5     !<maximum part of IN/SRP/DS pool that can be used for production per timestep
    REAL,PARAMETER :: maxdegradwater  = 0.5     !<maximum part of ON/PP/OC/AS pool that can be degraded per timestep
...
!>\{
  ...
  REAL, ALLOCATABLE :: riverrc(:,:,:)      !<recession parameter for river damping (coefficient,rivertype,subbasin)
...
!>\name Variables for lakes
!>
!>\{
  !Model variable for distance between lake bottom and outflow threshold (for a bathtub lake)
  REAL, ALLOCATABLE :: thresholddepth(:,:)      !<current distance between lake bottom and outflow threshold (laketype,subbasin) [m]
!>\}
    ...
    REAL riverQ365Temp(366)
      ...
      DO i = 1,nsub
        DO j = 1,2
          ...
          DO k = 1, 366
            IF(riverQ365Temp(k) >= Qmax(j,i))THEN 
              Q2max(j,i) = Qmax(j,i)
              iQ2max(j,i) = iQmax(j,i)
              Qmax(j,i) = riverQ365Temp(k)
              iQmax(j,i) = k
            ELSEIF(riverQ365Temp(k) > Q2max(j,i))THEN
              Q2max(j,i) = riverQ365Temp(k)
              iQ2max(j,i) = k
            ENDIF
          ENDDO
        ENDDO
